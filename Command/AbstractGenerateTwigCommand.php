 ...
 */
abstract class AbstractGenerateTwigCommand extends ContainerAwareCommand
{
    ...
    protected function getViewType() {
        ...
        throw new \Exception("View type not set");
   ...
   //?
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln("Twig {$this->getFileName()} generated");
    }
    ...
    protected function addFile($entityName, $fieldsInfo, $rootFolder,$configEntityName)
    {
        ...
        $objectName = $entityReflection->getShortName();
        $directory = $this->createDirectory($classPath, $entityNamespace, $objectName, $rootFolder,$configEntityName,$this->getViewType());
        ...
        $renderedConfig = $templating->render($this->getTemplatePath(), [
