 ...
 */
class GenerateTwigContainerViewCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $renderedConfig = $templating->render("CorePrototypeBundle:Command:container.view.template.twig", [
        ...
        $output->writeln("Twig:containter:view generated");
    }
