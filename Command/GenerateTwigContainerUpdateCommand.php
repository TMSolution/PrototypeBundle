 ...
 */
class GenerateTwigContainerUpdateCommand extends  AbstractGenerateTwigCommand 
{
    ...
    protected function configure()
    {
        ...
        $this->templatePath="CorePrototypeBundle:Command:container.update.template.twig";
