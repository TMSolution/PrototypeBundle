 ...
 */
class GenerateTwigContainerCreateCommand extends AbstractGenerateTwigCommand
{
    ...
    protected function configure()
    {
        ...
        $this->templatePath="CorePrototypeBundle:Command:container.create.template.twig";
