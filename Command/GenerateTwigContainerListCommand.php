...
class GenerateTwigContainerListCommand extends ContainerAwareCommand
{
    ...
    protected function getListConfigNamespaceName($entityName)
    {

        $entityNameArr = explode("\\", str_replace("Entity", "List", $entityName));
    ...
    protected function calculateFileName($entityReflection)
    {
        ...
        $fileName = $this->replaceLast("Entity", "List", $entityReflection->getFileName());
        return $fileName;
    }
