...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode->children()
                ...
                ->scalarNode('twig_element_grid')->defaultValue('CorePrototypeBundle:Default\Element:grid.html.twig')->end()
                ->scalarNode('twig_element_ajaxgrid')->defaultValue('CorePrototypeBundle:Default\Element:grid.ajax.html.twig')->end()
                ...
                ->scalarNode('twig_container_grid')->defaultValue('CorePrototypeBundle:Default\Container:grid.html.twig')->end()
