...
use Core\PrototypeBundle\Component\ORM\Tools\EntityGenerator;

/**
 * GenerateFilesCommand generates all configuration.
 * @author Jacek Łoziński <jacek.lozinski@tmsolution.pl>
 */
class GenerateEntitiesDoctrineWithToStringMethodCommand extends GenerateEntitiesDoctrineCommand
{

    protected function configure()
    {
        $this
                ->setName('prototype:generate:entities')
                ->setDescription('Generates entity classes and method stubs with __toString')
                ...
                ->addOption('with-tostring', null, InputOption::VALUE_NONE, 'Generate __toString() method.')
                ->setHelp(<<<EOT
